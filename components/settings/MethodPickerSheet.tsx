  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-end bg-black/60" role="dialog" aria-modal="true">
      ...
      <div className="relative w-full rounded-t-3xl border-t border-white/10 bg-[#0B1220] p-4 pb-6 max-h-[86vh] overflow-y-auto">
        ...
        <h3 className="text-base font-semibold text-white">Metode Perhitungan</h3>
        <p className="mt-1 text-xs text-slate-400">Pilih sumber perhitungan untuk jadwal sholat.</p>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  {selected ? <Check size={16} className="text-cyan-300" /> : null}
                </div>
              </button>
            );
          })}
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          ...
          <button
            ...
            className="rounded-xl border border-cyan-300/40 bg-cyan-500/20 py-2 text-sm font-semibold text-cyan-100 disabled:opacity-50"
          >
            Simpan
          </button>
        </div>
