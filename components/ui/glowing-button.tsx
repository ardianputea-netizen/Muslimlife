  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "border-zinc-100 from-white to-neutral-100 text-foreground hover:text-foreground/80 dark:border-zinc-800 dark:from-zinc-900 dark:to-neutral-800 dark:text-white dark:hover:text-white/80",
